...
const VISUAL_REGISTRY: Record<string, {
    ...
    'layout.navbar': {
        renderIcon: (cls = 'size-4') => <Compass className={cls} />,
        textColor: 'text-blue-600 dark:text-blue-400',
        bgColor: 'bg-blue-500/10',
        borderColor: 'border-blue-500/20',
        category: 'layout',
    ...
    'marketing.blurb': {
        renderIcon: (cls = 'size-4') => <Award className={cls} />,
        textColor: 'text-indigo-600 dark:text-indigo-400',
        bgColor: 'bg-indigo-500/10',
        borderColor: 'border-indigo-500/20',
        category: 'marketing',
    ...
    'content.list': {
        renderIcon: (cls = 'size-4') => <ListChecks className={cls} />,
        textColor: 'text-emerald-600 dark:text-emerald-400',
        bgColor: 'bg-emerald-500/10',
        borderColor: 'border-emerald-500/20',
        category: 'content',
    },
    'marketing.imagefeature': {
        renderIcon: (cls = 'size-4') => <PanelRight className={cls} />,
        textColor: 'text-violet-600 dark:text-violet-400',
        bgColor: 'bg-violet-500/10',
        borderColor: 'border-violet-500/20',
        category: 'marketing',
    ...
    'media.gallery': {
        renderIcon: (cls = 'size-4') => <Images className={cls} />,
        textColor: 'text-rose-600 dark:text-rose-400',
        bgColor: 'bg-rose-500/10',
        borderColor: 'border-rose-500/20',
        category: 'media',
