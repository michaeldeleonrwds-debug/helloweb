    ...
    public static function all(): array
    {
        ...
        return [
            ...
            new ComponentDefinition(
                ...
                defaultStyles: ['desktop' => ['display' => 'flex', 'flexDirection' => 'row', 'width' => '100%', 'maxWidth' => '900px', 'margin' => '0 auto', 'padding' => '10px', 'backgroundColor' => 'transparent', 'gap' => '1rem', 'flexWrap' => 'nowrap']],
                styleCapabilities: ['display', 'width', 'minHeight', 'maxWidth', 'margin', 'padding', 'gap', 'flexDirection', 'justifyContent', 'alignItems', 'flexWrap', 'overflow', 'position', 'borderWidth', 'borderStyle', 'borderColor', 'borderRadius', 'boxShadow', 'opacity', 'backgroundColor'],
                propSchema: [],
            ...
            new ComponentDefinition(
                ...
                capabilities: ['canHaveChildren' => true, 'canAcceptChildren' => true, 'supportsResponsiveStyles' => true],
                defaultStyles: ['desktop' => ['display' => 'flex', 'flexDirection' => 'column', 'gap' => '1rem', 'width' => '100%', 'maxWidth' => '900px', 'margin' => '0 auto', 'padding' => '10px', 'backgroundColor' => 'transparent']],
                styleCapabilities: ['display', 'width', 'minWidth', 'maxWidth', 'minHeight', 'margin', 'padding', 'gap', 'flexDirection', 'justifyContent', 'alignItems', 'flexWrap', 'overflow', 'position', 'borderWidth', 'borderStyle', 'borderColor', 'borderRadius', 'boxShadow', 'opacity', 'backgroundColor'],
                propSchema: [],
            ...
            new ComponentDefinition(
                ...
                styleCapabilities: ['display', 'width', 'maxWidth', 'margin', 'padding', 'gap', 'flexDirection', 'justifyContent', 'alignItems', 'flexWrap', 'overflow', 'position', 'borderWidth', 'borderStyle', 'borderColor', 'borderRadius', 'boxShadow', 'opacity', 'backgroundColor'],
                propSchema: [],
                childRules: [
